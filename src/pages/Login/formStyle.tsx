export const labelStyle = "mb-2 text-sm font-medium text-gray-900";
...
export const validSuccess = "mt-2 text-sm text-blue-600";

export const validError = "mt-2 text-sm text-red-600";
